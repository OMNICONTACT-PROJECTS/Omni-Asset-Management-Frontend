    ...
    <div className="flex flex-col bg-white shadow-sm col-span-full sm:col-span-6 xl:col-span-4 dark:bg-gray-800 rounded-xl">
      <div className="px-5 pt-5">
        <header className="flex items-start justify-between mb-2">
          <h2 className="mb-2 text-lg font-semibold text-gray-800 dark:text-gray-100">Active Laptops</h2>
          {/* Menu button */}
        ...
        <div className="flex items-start">
          <div className="mr-2 text-3xl font-bold text-gray-800 dark:text-gray-100">428</div>
        </div>
      </div>
